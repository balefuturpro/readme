...
| Couche| Rôle                                                                                                                     |
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| **Server-Side Rendering (SSR)** | Permet de gérer le rendu initial des pages côté serveur via Express et Vite SSR Renderer, avant que Vue ne prenne le relais côté client.                                                                                     |
